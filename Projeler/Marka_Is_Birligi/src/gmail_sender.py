...
# Credential dosya yolları (lokal geliştirme için).
CREDENTIALS_FILE = os.path.join(BASE_DIR, "..", "..", "_knowledge", "credentials", "oauth", "gmail-credentials.json")
TOKEN_FILE = os.path.join(BASE_DIR, "..", "..", "_knowledge", "credentials", "oauth", "gmail-token.json")
...
def authenticate():
    ...
    token_json_str = os.environ.get("GOOGLE_OAUTH_TOKEN_JSON")
    if token_json_str:
        try:
            # Base64 decode
        ...
        if creds and creds.expired and creds.refresh_token:
            ...
            if not os.path.exists(CREDENTIALS_FILE):
                raise FileNotFoundError(
                    ...
                    "Railway'de: GOOGLE_OAUTH_TOKEN_JSON env var ayarlayın."
                )
