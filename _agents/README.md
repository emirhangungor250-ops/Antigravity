...
**Amaç:** Seçilen niş için içerik üretim sürecini (araştırma → script yazma → video prompting) uçtan uca yönetmek.
...
icerik-uretim/
├── AGENT.md          ← Orkestrasyon yönergesi
├── config/           ← Marka profili (ornek-musteri.yaml)
...
**İlişkili Workflow'lar:** `/proje-paylas`
