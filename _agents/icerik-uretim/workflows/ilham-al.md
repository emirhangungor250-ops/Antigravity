---
description: Rakip videolarından ilham alarak marka tarzında script üret
---
...
Rakip videolarından ilham alarak orijinal script üretme adımları.
...
- **Transcript Aracı:** `Projeler/<ICERIK_PROJESI>/tools/transcript.py` (Supadata API)
...
2. **Transcript al**
   ```bash
   python Projeler/<ICERIK_PROJESI>/tools/transcript.py [VIDEO_URL]
   ```
...
4. **Config'den marka ayarlarını çek**
   ...
   - Marka tonunu ve yasak ifadeleri doğrula

5. **Marka versiyonunu yaz**
   - SKILL.md → "İlham Alma Kuralları" bölümüne bak
   - Konuyu al, anlatımı **tamamen yeniden yaz**
   - Markanın sesini ve dilini kullan
