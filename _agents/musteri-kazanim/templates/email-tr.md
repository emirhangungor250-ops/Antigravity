...
> **Kaynak:** influencer outreach projelerinden toplanmıştır.
...
| `{gonderici_adi}` | Gönderen kişinin adı | <GONDERICI_ADI> |
...
**Senaryo:** Etkinlik/festival için influencer'a ulaşma
