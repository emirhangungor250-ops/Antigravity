...
|-----------------|-----------------|
| Proje ismi değişti | İzleme/watchdog projeleri (config dosyasındaki proje listesi) |
| Google Sheet tab ismi değişti | O sheet'i okuyan tüm projeler |
| Notion DB yapısı değişti | O DB'yi okuyan/yazan tüm projeler |
...
## Adım 5.5 — i18n Kontrol (Çok Dilli Web Projeleri İçin ZORUNLU)

> Bu adım **sadece** çok dilli (i18n) bir web projesinde metin değişikliği yapıldığında uygulanır.
...
- README: ✅ Güncel
- i18n: ✅ 4 dil güncel (çok dilli web projesi ise)
