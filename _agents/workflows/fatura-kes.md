...
## 🛠 Kullanım Amacı
Kullanıcının tek yapması gereken markayı ve fiyatı vermektir — ya da "e-postadan bak" demektir. Fatura üzerindeki *Description* kısmında doğrudan "`[Brand]` collaboration with @<KULLANICI_HANDLE>" formatı uygulanır. İsimlendirme ise özel olarak `INVOICE_[Marka]_[GG-AA-YYYY].pdf` şeklinde yapılır.
...
3. Ayrıca kullanıcıya üretilen PDF'in yolunu ver: `_skills/fatura-olusturucu/uretilen-faturalar/INVOICE_Marka_GG-AA-YYYY.pdf`
