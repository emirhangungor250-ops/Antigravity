...
- **Genel desen:** `<KULLANICI_ADI>[a-z]*@[a-z]+\.[a-z]+` (kullanicinin profil.md’deki adina gore)
- **Placeholder:** `EMAIL_ADRESI_BURAYA`

### Kişisel URL'ler
- **Desen:** `<kullanici-domaini>.com`, `instagram.com/<kullanici-handle>` vb.
- **Placeholder:** `KISISEL_URL_BURAYA`

### Dosya Sistemi Yolları
- **Desen:** `/Users/<kullanici>/...`
