...
- **Nereden Alınır:** https://apify.com?fpr=dfev5h → Settings → Integrations → Personal API Token
...
- **Nereden Alınır:** https://kie.ai?ref=c29fcd9c92ad897e8868df9182112560 → API bölümü

### Telegram
- **Bot Token:** `BURAYA_KENDI_TELEGRAM_BOT_TOKENINIZI_YAZIN`
- **Kullanım:** Bot üzerinden bildirim ve içerik teslimi
- **Nereden Alınır:** Telegram'da https://t.me/BotFather ile yeni bot oluşturun (`/newbot`)
...
- **Nereden Alınır:** https://get.apollo.io/8voiw17w8t3z → Settings → Integrations → API
...
- **Nereden Alınır:** https://www.perplexity.ai → API Settings
...
- **Nereden Alınır:** https://try.elevenlabs.io/3wxzupqkfs06 → Developers → Create API Key
