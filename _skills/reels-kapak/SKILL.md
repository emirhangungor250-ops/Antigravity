...
name: reels-kapak
description: |
  Kullanıcının Instagram Reels/TikTok/Shorts videoları için AI destekli kapak fotoğrafı (thumbnail) üretimi.
...
Bu skill, Kullanıcının sosyal medya videoları için kapak fotoğrafı üretimini yönetir.
...
| `assets/cutouts/` | Kullanıcının arka planı kaldırılmış referans fotoğrafları (kendi fotoğraflarınızı koyun) |
